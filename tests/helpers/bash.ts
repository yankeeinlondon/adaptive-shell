 ...
 */
export function bashWithStderr(script: string, options?: BashOptions): string {
  try {
 ...
 * @returns Combined stdout and stderr output, trimmed
 */
export function sourcedBashWithStderr(file: string, script: string, options?: BashOptions): string {
 ...
 */
export function bashNoTrimStart(script: string, options?: BashOptions): string {
  try {
 ...
 * @returns The stdout output with only trailing whitespace removed
 */
export function sourcedBashNoTrimStart(file: string, script: string, options?: BashOptions): string {
